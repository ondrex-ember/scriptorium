const ItemsDB = {
    ...
    "goat_cheese_fresh": { name: "Kozí sýr (čerstvý)", name_en: "Goat Cheese (Fresh)", icon: "🧀", type: "mat", desc: "Čerstvý kozí sýr. Měkký, rychle se zkazí.", desc_en: "Fresh goat cheese. Soft, spoils quickly." },
    "goat_cheese_mature": { name: "Kozí sýr (zralý)", name_en: "Goat Cheese (Mature)", icon: "🧀", type: "mat", desc: "Vyzrálý kozí sýr. Pevnější, výraznější chuť.", desc_en: "Matured goat cheese. Firmer, sharper flavour." },
    "goat_cheese_aged": { name: "Kozí sýr (starý)", name_en: "Goat Cheese (Aged)", icon: "🧀", type: "mat", desc: "Dlouho zrálý kozí sýr. Vzácný, vysoce ceněný.", desc_en: "Long-aged goat cheese. Rare, highly prized." },
    "sheep_cheese_fresh": { name: "Ovčí sýr (čerstvý)", name_en: "Sheep Cheese (Fresh)", icon: "🧀", type: "mat", desc: "Čerstvý ovčí sýr. Měkký, rychle se zkazí.", desc_en: "Fresh sheep cheese. Soft, spoils quickly." },
    "sheep_cheese_mature": { name: "Ovčí sýr (zralý)", name_en: "Sheep Cheese (Mature)", icon: "🧀", type: "mat", desc: "Vyzrálý ovčí sýr. Pevnější, výraznější chuť.", desc_en: "Matured sheep cheese. Firmer, sharper flavour." },
    "sheep_cheese_aged": { name: "Ovčí sýr (starý)", name_en: "Sheep Cheese (Aged)", icon: "🧀", type: "mat", desc: "Dlouho zrálý ovčí sýr. Vzácný, vysoce ceněný.", desc_en: "Long-aged sheep cheese. Rare, highly prized." },
    "cow_cheese_fresh": { name: "Kravský sýr (čerstvý)", name_en: "Cow Cheese (Fresh)", icon: "🧀", type: "mat", desc: "Čerstvý kravský sýr. Měkký, rychle se zkazí.", desc_en: "Fresh cow cheese. Soft, spoils quickly." },
    "cow_cheese_mature": { name: "Kravský sýr (zralý)", name_en: "Cow Cheese (Mature)", icon: "🧀", type: "mat", desc: "Vyzrálý kravský sýr. Pevnější, výraznější chuť.", desc_en: "Matured cow cheese. Firmer, sharper flavour." },
    "cow_cheese_aged": { name: "Kravský sýr (starý)", name_en: "Cow Cheese (Aged)", icon: "🧀", type: "mat", desc: "Dlouho zrálý kravský sýr. Vzácný, vysoce ceněný.", desc_en: "Long-aged cow cheese. Rare, highly prized." },
    "syrecky_fresh": { name: "Syrečky (čerstvé)", name_en: "Curd Cheese (Fresh)", icon: "🧀", type: "mat", desc: "Čerstvé syrečky z kysaného tvarohu. Olomoucká specialita — bez syřidla.", desc_en: "Fresh curd cheese from soured curds. An Olomouc speciality — no rennet needed." },
    "syrecky_mature": { name: "Syrečky (zralé)", name_en: "Curd Cheese (Mature)", icon: "🧀", type: "mat", desc: "Vyzrálé syrečky. Pronikavá vůně, výrazná chuť.", desc_en: "Matured curd cheese. Pungent aroma, sharp flavour." },
