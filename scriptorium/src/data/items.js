const ItemsDB = {
    ...
    "goat_hide":      { name:"Kozí kůže",         name_en:"Goat Hide",        icon:"🦌", type:"mat", desc:"Pevná kozí kůže. Základ jemného pergamenu.", desc_en:"Tough goat hide. The basis of fine parchment." },
