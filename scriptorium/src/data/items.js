const ItemsDB = {
    ...
    "truhla": { name: "Truhla", name_en: "Curio Chest", icon: "🗝️", type: "tool", desc: "Kovaná truhla se zámkem. Uschová cenné nálezy a kuriozity — otevře vlastní přihrádku v Personě.", desc_en: "An ironbound chest with a lock. Holds precious finds and curiosities — opens its own compartment under Persona." },
