const ItemsDB = {
    ...
    "dried_herbs_bundle": { name:"Svazek sušených bylin", name_en:"Dried Herbs Bundle", icon:"🌿", type:"mat", lostItem:true,
    ...
    "hemp_pouch": { name:"Váček s konopím", name_en:"Hemp Pouch", icon:"👝", type:"mat", lostItem:true,
    ...
    "mysterious_bulb": { name:"Záhadný kořen", name_en:"Mysterious Bulb", icon:"🧅", type:"mat", lostItem:true,
    ...
    "lost_key_1": { name:"Rezavý klíč č.1", name_en:"Rusty Key #1", icon:"🗝️", type:"key", lostItem:true,
        desc:"Starý rezavý klíč. Neznámý původ. Třeba ho prozkoumat.", desc_en:"An old rusty key. Unknown origin. Worth examining." },
    "lost_key_2": { name:"Rezavý klíč č.2", name_en:"Rusty Key #2", icon:"🗝️", type:"key", lostItem:true,
        desc:"Starý rezavý klíč. Neznámý původ. Třeba ho prozkoumat.", desc_en:"An old rusty key. Unknown origin. Worth examining." },
    "lost_key_3": { name:"Rezavý klíč č.3", name_en:"Rusty Key #3", icon:"🗝️", type:"key", lostItem:true,
        desc:"Starý rezavý klíč. Neznámý původ. Třeba ho prozkoumat.", desc_en:"An old rusty key. Unknown origin. Worth examining." },
    "lost_key_4": { name:"Rezavý klíč č.4", name_en:"Rusty Key #4", icon:"🗝️", type:"key", lostItem:true, maxStack:4,
    ...
    "lost_key_5": { name:"Rezavý klíč č.5", name_en:"Rusty Key #5", icon:"🗝️", type:"key", lostItem:true,
    ...
    "chicory_drink":       { name:"Čekankový nápoj",    name_en:"Chicory Drink",       icon:"🥤", type:"food", desc:"Z kořene čekanky vařeného s vodou. Starobylý klášterní lék na únavu.", desc_en:"From chicory root boiled with water. An ancient monastic remedy for fatigue." },
    ...
    "rabbit":         { name:"Králík",            name_en:"Rabbit",           icon:"🐇", type:"animal", desc:"Živý králík z trhu. V králíkárně se množí rychleji, než stačíš počítat.", desc_en:"A live rabbit from the market. In the hutch they multiply faster than you can count." },
