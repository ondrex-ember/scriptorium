const ItemsDB = {
    ...
    "pigeon_squab": { name: "Holoubě", name_en: "Squab", icon: "🍗", type: "food_raw", hunger: 6, desc: "Mladý, nevzletný holub. Uvař před jídlem. Historicky cennější pečeně než dospělý pták — v klášteře patřilo hlavně na stůl infirmária nebo vzácného hosta.", desc_en: "A young, unfledged pigeon. Cook before eating. Historically a more prized roast than an adult bird — in the monastery it belonged chiefly on the table of the infirmary or an honoured guest." },
    "pigeon_meat": { name: "Holubí maso", name_en: "Pigeon Meat", icon: "🍖", type: "food_raw", hunger: 4, desc: "Maso dospělého holuba z holubníku. Uvař před jídlem. Méně cenné než holoubě, ale poctivá potrava.", desc_en: "Meat from an adult dovecote pigeon. Cook before eating. Less prized than squab, but honest food." },
