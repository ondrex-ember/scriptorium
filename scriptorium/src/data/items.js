const ItemsDB = {
    ...
    "primitive_torch": { name: "Louč (sádlová)", name_en: "Torch (lard)", icon: "🪵", type: "tool", tier: "fire", lightHours: 1, desc: "Nouzová louč ze sádla. Rychle se rozteče a hoří jen krátce, navíc čadí. 1h světla.", desc_en: "Emergency torch made with lard. Melts fast and burns only briefly, and smokes badly. 1h of light." },
