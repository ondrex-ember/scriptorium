...
TechTree.push({
    ...
    cost: 15,
    desc: "Opat žije daleko a jezdí jen na návštěvu. Nabízí hejno holubů pro výcvik a spojení. Odemkne: recept Ptačího papíru — bez něj holubí pošta nedoletí.",
    desc_en: "The Abbot lives far away and visits only occasionally. He offers a flock of pigeons for training and connection. Unlocks: the Bird Paper recipe — without it, the pigeon post cannot fly.",
    unlocks: ["bird_paper"],
    requires: []
});
// ── VÁPENICE (Calcaria) ──────────────────────────────────────────────────
TechTree.push({
    ...
    unlocks: ["vapenice", "burn_lime", "slake_lime", "soaked_hide_lime"],
