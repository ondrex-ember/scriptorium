const TechTree = [
  ...
  // VELLUM
  { id: "tech_vellum_prep", name: "Příprava Pergamenu", name_en: "Vellum Preparation", cost: 5, desc: "Loužení kůže ve vápenné lázni. Historicky 3–4 dny.", desc_en: "Soaking hide in lime water. Historically 3–4 days.", unlocks: ["soaked_hide", "stretched_hide", "ash_water"], requires: [] },
  ...
  // CHLÉV (Ovile) — odemkne stavbu chléva ve Dvoře
  {
    ...
    unlocks: ["sulci", "feed_meal_rye", "feed_meal_wheat", "feed_meal_barley", "feed_meal_oats", "feed_meal_millet", "feed_meal_peas", "rye_to_seed", "wheat_to_seed", "barley_to_seed", "oats_to_seed", "millet_to_seed", "peas_to_seed"], requires: ["tech_garden_expand"]
  },
