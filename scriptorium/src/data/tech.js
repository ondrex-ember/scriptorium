const TechTree = [
  ...
  { id: "tech_scriptorium_ars", name: "Umění opisu", name_en: "Art of the Copy", cost: 5, desc: "Základní řemeslo skriptoria — jak správně vést brk a řadit řádky. Odemyká: opisování rukopisů v sekci Skriptorium.", desc_en: "The scriptorium's basic craft — how to properly guide a quill and set lines straight. Unlocks: manuscript copying in the Scriptorium section.", unlocks: [], requires: [] },
  ...
  { id: "tech_anathema", name: "Knižní Kletba", name_en: "Book Curse", cost: 6, desc: "Písař vepíše do desek kletbu proti zlodějům — hrozbu zežloutlé krve a pekelného ohně. Odemyká: výrobu Kletebného inkoustu (Výroba).", desc_en: "The scribe inscribes a curse against thieves into the boards — a threat of blackened blood and hellfire. Unlocks: crafting Anathema Ink (Production).", unlocks: ["anathema_ink"], requires: ["tech_bibliotheca_catalogus"] },
  { id: "tech_catena", name: "Přikované Knihy", name_en: "Chained Books", cost: 12, desc: "Nejvzácnější svazky se přikovávají řetězem k pultu — čtou se na místě, neodnáší se. Odemyká: výrobu Řetězu a zámku (Výroba).", desc_en: "The rarest volumes are chained to the lectern — read in place, never carried off. Unlocks: crafting Chain and Lock (Production).", unlocks: ["chain_lock"], requires: ["tech_anathema"] },
  { id: "tech_libraria_secreta", name: "Libraria Secreta", name_en: "Libraria Secreta", cost: 20, desc: "Uzamykatelná komora pro nejnebezpečnější svazky, dvojí klíč — opat a celerář. Odemyká: zakázku trezorového okování u Kováře. Vyžaduje hodnost Armaria.", desc_en: "A lockable chamber for the most dangerous volumes, a double key — abbot and cellarer. Unlocks: a commission for vault fittings from the Blacksmith. Requires the rank of Armarius.", unlocks: [], requires: ["tech_catena"] },
  { id: "tech_conservatio", name: "Knižní Nemocnice", name_en: "Book Infirmary", cost: 10, desc: "Vlhkost a prach jsou nepřítelem pergamenu — Armarius zavádí pravidelnou údržbu fondu proti plísni a červotoči, nejhorší v zimě. Odemyká: údržbu a opravu poškozených svazků.", desc_en: "Damp and dust are the enemy of parchment — the armarius introduces regular upkeep against mould and bookworm, worst in winter. Unlocks: maintenance and repair of damaged volumes.", unlocks: [], requires: ["tech_bookbinding"] },
  { id: "tech_liber_domesticus", name: "Kronika našeho kláštera", name_en: "Chronicle of Our Monastery", cost: 12, desc: "Armarius založí vlastní klášterní kroniku — vázaný svazek, do kterého se v čase vpisuje skutečná historie tohoto domu. Kniha se odemkne až se nasbírá dost let a událostí.", desc_en: "The armarius founds the monastery's own chronicle — a bound volume into which this house's real history is inscribed over time. The book unlocks once enough years and events have accumulated.", unlocks: [], requires: ["tech_bibliotheca_catalogus"] },
  { id: "tech_ars_moriendi", name: "Ars Moriendi", name_en: "Ars Moriendi", cost: 10, desc: "Skriptorium opisuje traktát Ars Moriendi — umění dobré smrti, s dřevořezy pokušení u lůžka umírajícího. Vede armaria k založení vlastního nekrologia: záznamu o těch, kdo v klášteře nalezli poslední odpočinek.", desc_en: "The scriptorium copies the Ars Moriendi — the art of dying well, with woodcuts of the deathbed temptations. It leads the armarius to found the monastery's own necrology: a record of those who found their final rest here.", unlocks: [], requires: ["tech_bibliotheca_catalogus"] },
  { id: "tech_absentee_lending", name: "Výpůjčka Mimo Klášter", name_en: "Absentee Lending", cost: 15, desc: "Kniha smí opustit zdi kláštera proti zástavě — třetina nad její hodnotu, jak velela dobová praxe. Riziko nenávratnosti neseš ty. Vyžaduje hodnost Priora.", desc_en: "A book may leave the monastery walls against a pledge — a third above its worth, as period practice demanded. The risk of non-return is thine to bear. Requires the rank of Prior.", unlocks: [], requires: ["tech_studovna"] },
  { id: "tech_marc", name: "Řád bratra Marka (M.A.R.C.)", name_en: "Brother Marek's Order (M.A.R.C.)", cost: 60, desc: "Bratr Marek sestavil vlastní metodu — Modus Archivandi Recte Catalogandi (\"způsob správného archivování a katalogizace\") — jak měřit formát, ověřovat autorské záhlaví, třídit obor a ukládat svazek do správného regálu. Zvláštně systematické na jednoho bratra. Odemyká: katalogizační zkoušku a formátové regály.", desc_en: "Brother Marek devised his own method — Modus Archivandi Recte Catalogandi (\"the way of rightly archiving and cataloguing\") — for measuring format, verifying authorial heading, classifying subject, and shelving the volume correctly. Oddly systematic for one brother. Unlocks: the cataloguing examination and format shelving.", unlocks: [], requires: ["tech_bibliotheca_catalogus"] },
  { id: "tech_scriptorium_catalogus", name: "Rejstřík Bádání", name_en: "Research Index", cost: 6, desc: "Armarius sestavil rejstřík bádání — odemyká filtrování (Vše / Vyzkoumané / Nevyzkoumané) v sekci Scriptorium.", desc_en: "The armarius compiled a research index — unlocks filtering (All / Researched / Unresearched) in the Scriptorium section.", unlocks: [] },
  ...
  { id: "tech_susarna_industria", name: "Susarna Industria — Průmyslová Sušárna", name_en: "Susarna Industria — Industrial Drying Rack", cost: 25, desc: "Foculus stačí na hrst konopí, ne na dubové klády. Vlastní sušárenská plocha v Pracovně — víc surovin, víc najednou, ve větším měřítku. Odemkne: Sušárna tab v Pracovně, sušení dubu na stavbu vodního mlýna.", desc_en: "The Foculus suffices for a handful of hemp, not oak logs. A dedicated drying yard in the Workshop — more materials, more at once, at scale. Unlocks: the Drying Rack tab in the Workshop, oak drying for the water mill.", unlocks: ["cannabis", "oak"], requires: ["tech_susarna"] },
  ...
  { id: "tech_ars_recreationis", name: "Ars Recreationis", name_en: "Ars Recreationis", cost: 30, desc: "Statuta o pouštění žilou a tridenním zotavení bratří (Melčké zvyklosti) — únava se odbourává rychleji, jak triduum po minuci učí.", desc_en: "Statutes on bloodletting and the brethren's three-day recovery (Melk customs) — fatigue recovers faster, as the triduum after bloodletting teaches.", unlocks: [], requires: ["tech_monastery_wisdom"], requiresBook: "liber_de_recreatione" },
  ...
  { id: "tech_athanor_ars_magna", name: "Ars Magna", name_en: "Ars Magna", cost: 18, desc: "Ramon Llull v Ars generalis ultima (počátek 14. stol.) popsal otočná kola popsaná vlastnostmi věcí — mechanicky se jimi procházely možné kombinace pravd, místo aby se hádaly naslepo. Odemyká: Circulus Lullianus a Výzkum v Athanoru.", desc_en: "Ramon Llull's Ars generalis ultima (early 14th century) described rotating wheels inscribed with the properties of things — mechanically working through possible combinations of truths instead of guessing blindly. Unlocks: the Circulus Lullianus and Research at the Athanor.", unlocks: ["circulus_lullianus"], requires: ["tech_athanor_quaternio"], requiresBook: "book_ars_magna" },
  { id: "tech_athanor_confectio", name: "Ars Conservandi", name_en: "The Art of Preserving", cost: 10, desc: "Platina v De Honesta Voluptate et Valetudine popsal ovocné pasty a zavařeniny — kdoulovou marmeladu především. Odemyká v Athoru: 7 zavařeninových receptur z ovoce sadu i divokého sběru.", desc_en: "Platina's De Honesta Voluptate et Valetudine described fruit pastes and preserves — quince marmalade above all. Unlocks in the Athanor: 7 preserve recipes from both orchard and wild fruit.", unlocks: ["berry_jam", "apple_jam", "quince_marmalade", "plum_jam", "cornel_cherry_jam", "wild_fruit_jam", "spiced_marmalade"], requires: ["tech_athanor_ars_magna"], requiresBook: "book_platina_honesta" },
  ...
  {
    id: "tech_sokoban",
    name: "Knihovní uspořádání",
    name_en: "Monastic Cataloguing",
    cost: 8,
    desc: "Sokoban — skladnické a knihovní hlavolamy. Uspořádej svazky v klášterní knihovně podle témat.",
    desc_en: "Sokoban — cataloguing and shelving puzzles. Organize sacred codices by subject in the monastery library.",
    unlocks: ["sokoban_scroll"],
    requires: ["tech_games"]
  },
  ...
  { id: "tech_ius_terrae", name: "Ius Terrae — Zemské Právo", name_en: "Ius Terrae — Law of the Land", cost: 40, desc: "Klášterní pozemky podléhaly právu kanonickému, ale prodej přebytků za hradbami už zákonům města a jeho cechů. S touto znalostí může klášter požádat opata o formální jednání s cechy — o výjimku z mílového práva, o právo prodávat, co si sám vyrobí. Odemkne: žádost o Privilegium u cechů.", desc_en: "Monastery land answered to canon law, but selling surplus beyond the walls answered to the law of the town and its guilds. With this knowledge the monastery may petition the Abbot for formal dealings with the guilds — an exemption from the mile-right, the right to sell what it makes. Unlocks: petitioning guilds for a Privilege.", unlocks: ["pravo_privilegium"], requires: ["tech_commercium"] },

  { id: "tech_regalia", name: "Regálie — Královská Práva", name_en: "Regalia — Rights of the Crown", cost: 50, desc: "Regál — výsostné právo vrchnosti k lovu, těžbě, mlýnům a várce, propůjčitelné klášteru donací nebo koupí. Bez znalosti, jak takovou listinu formulovat a u koho ji vymoct, zůstane sebelepší pozemek jen snem. S touto znalostí může opat začít u Zemského pána jednat o rozšíření klášterního panství.", desc_en: "The regale — the crown's exclusive right to hunting, mining, milling and brewing, grantable to a monastery by donation or purchase. Without knowing how to draft such a charter, and with whom to press it, even the best plot of land remains a dream. With this knowledge the Abbot may open negotiations with the Lord of the Manor to expand the monastery's estate.", unlocks: ["pozemky_regalia"], requires: ["tech_commercium"] },
  ...
  {
    // dilny-pozemky-mrd.md v0.3, Furnus (Pekárna) — první ze čtyř dílen.
    // NENÍ totéž co tech_fornax výš (ten je pro Fornax Ferraria, kovářskou
    // huť — jiná stavba, jiný účel, jen sdílený latinský kořen "fornax").
    // Recept bread_fine je viditelný už z tech_cooking_1 — tenhle tech
    // odemyká jen možnost žádat opata o samotnou stavbu.
    id: "tech_furnus", name: "Furnus — Umění Pečení", name_en: "Furnus — The Art of Baking",
    cost: 20,
