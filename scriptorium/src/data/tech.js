const TechTree = [
    ...
    { id: "tech_czech_herbs",    name: "České Bylinkářství",      name_en: "Bohemian Herbalism",     cost: 8,  desc: "Měsíček, třezalka, dobromysl — české léčivé byliny známé od 12. století.", desc_en: "Calendula, St. John's Wort, marjoram — Bohemian healing herbs known since the 12th century.", unlocks: [], requires: ["tech_alchemy_2"] },
    ...
    { id: "tech_karnoffel",      name: "Karnöffel",               name_en: "Karnöffel",              cost: 12, desc: "Nejstarší trumfová hra Evropy! První zmínka Norimberk 1426. Církev ji zakazovala.", desc_en: "The oldest trump card game in Europe! First recorded in Nuremberg 1426. The Church banned it.", unlocks: ["karnoffel_deck"], requires: ["tech_primero"] },
