const RecipesDB = [
    ...
    { id:"stone_axe",    output:"stone_axe",    qty:1, req:{stick:2, rock:3, rope:1}, cat:"lore", locked:true,
    ...
    { id:"wooden_flail", output:"wooden_flail", qty:1, req:{stick:3, rope:2}, cat:"tool", locked:true,
      desc:"Prostý dřevěný cep. Základní mlácení obilí.", desc_en:"Simple wooden flail. Basic threshing tool." },
    { id:"stone_pickaxe",output:"stone_pickaxe",qty:1, req:{stick:2, rock:4, rope:2}, cat:"tool", locked:true,
    ...
    { id:"iron_axe",    output:"iron_axe",    qty:1, req:{iron_ingot:2, plank:1, rope:1, leather:1}, cat:"tool", locked:true, maxStack:1,
      desc:"Masivní sekera. 2 ingoty na hlavu, kůže na opich.", desc_en:"Heavy axe. 2 ingots for the head, leather grip." },
    { id:"iron_spade",  output:"iron_spade",  qty:1, req:{iron_ingot:1, plank:2, rope:1},            cat:"tool", locked:true, maxStack:1,
      desc:"Železná čepel. 2 prkna: násada a opěrka nohy.", desc_en:"Iron blade. 2 planks: shaft and foot rest." },
    { id:"iron_scythe", output:"iron_scythe", qty:1, req:{iron_ingot:2, stick:3, rope:2, leather:1}, cat:"tool", locked:true, maxStack:1,
      desc:"Dlouhá zahnutá čepel. Historicky 3dílná rukojeť.", desc_en:"Long curved blade. Historically 3-piece handle." },
    { id:"iron_sickle", output:"iron_sickle", qty:1, req:{iron_ingot:1, stick:1, rope:1, leather:1}, cat:"tool", locked:true, maxStack:1,
      desc:"Zahnutá čepel, krátká rukojeť, kůže na opich.", desc_en:"Curved blade, short handle, leather wrapping." },
    { id:"iron_flail",  output:"iron_flail",  qty:1, req:{iron_ingot:1, stick:3, rope:2, leather:1}, cat:"tool", locked:true, maxStack:1,
      desc:"Železné závaží, 3dílná rukojeť, provazový kloub.", desc_en:"Iron weight, 3-piece handle, rope joint." },
    { id:"iron_shovel", output:"iron_shovel", qty:1, req:{iron_ingot:1, plank:2, rope:1},            cat:"tool", locked:true, maxStack:1,
      desc:"Širší čepel než rýč. 2 prkna na pevnou násadu.", desc_en:"Wider blade than spade. 2 planks for a firm shaft." },
    { id:"iron_saw",    output:"iron_saw",    qty:1, req:{iron_ingot:2, plank:1, leather:1},         cat:"tool", locked:true, maxStack:1,
      desc:"Pilový list s mnoha zuby. 2 ingoty, dřevěný rám.", desc_en:"Saw blade with many teeth. 2 ingots, wooden frame." },
    { id:"iron_pickaxe",output:"iron_pickaxe",qty:1, req:{iron_ingot:2, stick:2, rope:1, leather:1}, cat:"tool", locked:true, maxStack:1,
      desc:"Těžká dvojitá hlava. 2 ingoty, dvojnásada.", desc_en:"Heavy double head. 2 ingots, double-hafted." },
    { id:"iron_tongs",  output:"iron_tongs",  qty:1, req:{iron_ingot:1, leather:1},                  cat:"tool", locked:true, maxStack:1,
    ...
    { id:"repair_iron_axe",    output:"iron_axe",    qty:1, req:{worn_iron_axe:1,     iron_tongs:1}, cat:"tool", locked:true, desc:"Překování a nabroušení sekerky.", desc_en:"Reforge and sharpen the axe." },
    { id:"repair_iron_spade",  output:"iron_spade",  qty:1, req:{worn_iron_spade:1,   iron_tongs:1}, cat:"tool", locked:true, desc:"Vyrovnání a oprava rýče.", desc_en:"Straighten and repair the spade." },
    { id:"repair_iron_scythe", output:"iron_scythe", qty:1, req:{worn_iron_scythe:1,  iron_tongs:1}, cat:"tool", locked:true, desc:"Nabroušení kosy na bruse.", desc_en:"Sharpen the scythe on the grindstone." },
    { id:"repair_iron_sickle", output:"iron_sickle", qty:1, req:{worn_iron_sickle:1,  iron_tongs:1}, cat:"tool", locked:true, desc:"Nabroušení a překování srpu.", desc_en:"Sharpen and reforge the sickle." },
    { id:"repair_iron_flail",  output:"iron_flail",  qty:1, req:{worn_iron_flail:1,   iron_tongs:1}, cat:"tool", locked:true, desc:"Utažení závaží, nové spojení.", desc_en:"Tighten the weight, new joint." },
