const RecipesDB = [
  ...
  // pekarna-audit v3 (30.8.2026) — req tady je jen pro locked-gate/UI
  // lookup, skutečná mechanika (COOK_TYPES) žije v CookingSystem.js.
  { id: "pernik", output: "pernik", qty: 1, req: { "flour_1": 2, "honey": 2, "skorice": 1, "cooking_pot": 0 }, cat: "food", locked: true },
  { id: "preclik", output: "preclik", qty: 3, req: { "flour_2": 2, "water": 1, "salt": 1, "cooking_pot": 0 }, cat: "food", locked: true },
  { id: "postni_chleb", output: "postni_chleb", qty: 2, req: { "flour_2": 2, "water": 1, "cooking_pot": 0 }, cat: "food", locked: true },
  ...
  {
    id: "iron_knife", output: "iron_knife", qty: 1, req: { iron_ingot: 1, stick: 1, rope: 1 }, cat: "iron", locked: true, maxStack: 1,
    desc: "Malé železné ostří na dřevěné rukojeti. Vydrží mnohem déle než kamenné.", desc_en: "A small iron blade on a wooden haft. Lasts far longer than stone."
  },
  {
  ...
  { id: "repair_iron_knife_whetstone", output: "iron_knife", qty: 1, req: { worn_iron_knife: 1 }, toolReq: [{ item: "whetstone" }], cat: "iron", locked: true, desc: "Nabroušení nože obtahovacím kamenem.", desc_en: "Hone the knife with a whetstone." },
