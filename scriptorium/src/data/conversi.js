...
const ConversiRosterDB = {
    k_jakub: {
        ...
        quotes: {
            ...
            farewell: { cs: 'Odcházím tiše. Válku jsem přežil tak, že jsem nikdy nehleděl zpátky.',
                        en: 'I go quietly. I survived the war by never looking back.' }
        },
        traits: ['silak'],
    ...
    k_simon: {
        ...
        quotes: {
            ...
            farewell: { cs: 'Třicet let jsem se učil odcházet, pak jsem se odnaučil. Teď se to učím znovu — a jde mi to líp, než jsem čekal.',
                        en: 'Thirty years I learned to leave, then unlearned it. Now I learn it again — and it goes better than I expected.' }
        },
    ...
    k_matej: {
        ...
        quotes: {
            ...
            farewell: { cs: 'Vale, fratres. Latinu jsem se naučil líp než pokoru — snad se to venku vyrovná.',
                        en: 'Vale, fratres. I learned Latin better than humility — perhaps out there the balance evens.' }
        },
        traits: ['ucenec'],
    ...
    k_ondrej: {
        ...
        quotes: {
            ...
            farewell: { cs: 'Zvířata se nikdy neloučí. Jen odejdou. Udělám to jako ony.',
                        en: 'Animals never say farewell. They simply go. I will do the same.' }
        },
        traits: ['samotar'],
    ...
    k_tomas: {
        ...
        quotes: {
            ...
            farewell: { cs: 'Kaše se vaří, dokud nedojde mouka. Moje došla. Někde jinde ji zase najdu.',
                        en: 'Porridge is cooked until the flour runs out. Mine has. I will find more elsewhere.' }
        },
        traits: ['upovidany'],
    ...
    k_vojtech: {
        ...
        quotes: {
            ...
            farewell: { cs: 'Přišel jsem beze jména. Odcházím stejně. To ticho vám nechávám zadarmo.',
                        en: 'I came without a name. I leave the same way. That silence I leave you for free.' }
        },
        traits: ['trpelivy'],
    ...
    k_blazej: {
        ...
        quotes: {
            ...
            farewell: { cs: 'Spoj, co jsem tu udělal, drží dýl než já. To budiž mou zpovědí.',
                        en: 'The joint I made here holds longer than I did. Let that be my confession.' }
        },
        traits: ['chrapoun'],
    ...
    k_havel: {
        ...
        quotes: {
            ...
            farewell: { cs: 'Vytáhl jsem vůz z horšího bláta, než je tohle loučení. Cesta mě čeká — vlci prý letos slabší.',
                        en: 'I have pulled a cart from worse mud than this farewell. The road awaits — the wolves, they say, are thinner this year.' }
        },
        traits: ['upovidany'],
    ...
    k_prokop: {
        ...
        quotes: {
            ...
            farewell: { cs: 'Ruce, co držely, teď pustí. To taky bolí. Ale nechvěje se.',
                        en: 'Hands that held now let go. That hurts too. But they do not shake.' }
        },
        traits: ['pilny'],
    ...
    k_bartolomej: {
        ...
        quotes: {
            ...
            farewell: { cs: 'Bohu sloužím rukama i mimo tyhle zdi. On prý všude slyší stejně — i mě, i s mou latinou.',
                        en: 'I serve God with my hands beyond these walls too. He hears the same everywhere, they say — even me, even with my Latin.' }
        },
        traits: ['zbozny'],
    ...
    k_jilji: {
        ...
        quotes: {
            ...
            farewell: { cs: 'Určitě něco cestou upustím. Ale snad ne vaši trpělivost — tu jsem už dávno vyčerpal.',
                        en: 'I will surely drop something along the way. But hopefully not your patience — that I exhausted long ago.' }
        },
        traits: ['nesika'],
    ...
    k_rehor: {
        ...
        quotes: {
            ...
            farewell: { cs: 'Za mých časů se loučilo kratčeji. Tak — sbohem. Hleďte na klášter líp, než jsem to čekal.',
                        en: 'In my day farewells were shorter. So — farewell. Look after the monastery better than I expected you would.' }
        },
        traits: ['mrzout'],
    ...
    k_vit: {
        ...
        quotes: {
            ...
            farewell: { cs: 'Babka říkala, že i kořen se jednou musí přesadit, má-li růst dál. Jdu najít novou půdu.',
                        en: 'Grandmother used to say even a root must sometimes be replanted, if it is to keep growing. I go to find new soil.' }
        },
        traits: ['bylinkar'],
