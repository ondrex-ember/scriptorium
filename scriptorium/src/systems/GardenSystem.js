...
const GardenSystem = {
    ...
    // plantTree odstraněno (19.8.2026) — mrtvá duplicita, tlačítko vždy
    // volalo Game.plantTree() (core/game.js přes GardenManager.js po Kroku 2
    // D3), tahle kopie se nikdy nespustila. Viz refactoring-audit-mrd-19-8-2026.md.
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // 19 metod odstraněno (19.8.2026) — mrtvé duplicity Piscina/Gallinarium/Ovile,
    // stejný vzorec jako feedPiscina výše (10.8.2026): tlačítka vždy volala živé
    // Game.* verze (core/game.js, po Kroku 2 přes PiscinaManager.js), tyhle kopie
    // se nikdy nespustily. Odstraněno: buildPiscina, addFry, transferFry,
    // harvestCarp, checkPiscinaGrowth, checkOrchardGrowth, buildHenhouse, addHen,
    // startNesting, slaughterChick, slaughterHen, collectHenhouse, buildSheepfold,
    // addSheep, startBreeding, slaughterLamb, slaughterSheep, collectSheepfold,
    // checkFarmyardProduction. Viz refactoring-audit-mrd-19-8-2026.md §Krok 2.
    // ═══════════════════════════════════════════════════════════════════════════
