...
const CommitmentsSystem = {
    ...
    // Cechy (cechy-a-prava-mrd.md §3.0, K3 Cesta A, 16.8.2026) — mirror
    // _VRCHNOST_ZAKAZKY_CATALOG vzoru (abstraktní odesílatel bez
    // ContactsDB záznamu), ale víc odesílatelů (4 aktivní cechy, ne 1).
    // guildRelationReward zapisuje do GameState.guildRelation[actorId],
    // NE contactRelation — CommitmentsSystem resolver to už rozlišuje.
    // 1 zakázka na cech = 1 historicky doložený motiv (podklad č.1/2):
    // cechovní listiny/stanovy (skriptorium jako "cloud"), surovinové
    // injekce (dubové klády, uhlí). Rozšíření o další varianty per cech
    // — TBD, viz cechy-a-prava-mrd.md §8.
    _CECH_ZAKAZKY_CATALOG: {
        mlynarsky: [
            {
                key: 'cechovni_artikule',
                icon: '⚖️',
                senderName_cs: 'Mlynářský cech', senderName_en: "The Millers' Guild",
                title_cs: 'Opis cechovních artikulí',
                title_en: 'A Copy of the Guild Articles',
                text_cs: 'Cechmistr mlynářů žádá o čistopis jejich starých, ohořelých artikulí — originál přežil požár krámu jen z poloviny, kopie musí sedět do puntíku, jinak neplatí u soudu.',
                text_en: "The millers' guildmaster asks for a fair copy of their old, singed articles — the original survived a shop fire only by half, and the copy must match to the letter, or it holds no weight in court.",
                requiredItems: [{ id: 'paper', qty: 2 }, { id: 'ink', qty: 1 }],
                rewardGrose: 12,
        ...
        truhlarsky: [
            {
                key: 'dubove_klady',
                icon: '🪵',
                senderName_cs: 'Truhlářský cech', senderName_en: "The Cabinetmakers' Guild",
                title_cs: 'Dubové klády z klášterního lesa',
                title_en: 'Oak Logs from the Monastery Forest',
                text_cs: 'Truhláři došlo kvalitní dubové dřevo — městský les je vytěžený, klášterní ne. Prosí o pár klád výměnou za dobrou vůli do budoucna.',
                text_en: "The cabinetmakers have run short of good oak — the town forest is logged out, the monastery's is not. They ask for a few logs, in exchange for goodwill toward the future.",
                requiredItems: [{ id: 'wood', qty: 6 }],
                rewardGrose: 5,
                guildRelationReward: 6,
            },
        ],
        kolarsky: [
            {
                key: 'jasanova_kola',
                icon: '🛞',
                senderName_cs: 'Kolářský cech', senderName_en: "The Wheelwrights' Guild",
                title_cs: 'Jasanové dřevo na loukotě',
                title_en: 'Ash Wood for Wheel Rims',
                text_cs: 'Koláři potřebují pružné jasanové dřevo na loukotě — dub je na to moc tvrdý a láme se. V klášterním hvozdu prý jasany rostou.',
                text_en: "The wheelwrights need supple ash wood for wheel rims — oak is too hard for it and cracks. Ash, they say, grows in the monastery's woods.",
                requiredItems: [{ id: 'wood', qty: 4 }],
                rewardGrose: 5,
                guildRelationReward: 6,
            },
        ],
        kovarsky: [
            {
                key: 'uhli_pro_vyhen',
                icon: '⚒️',
                senderName_cs: 'Kovářský a hamernický cech', senderName_en: "The Smiths' and Forgemasters' Guild",
                title_cs: 'Dřevěné uhlí pro výheň',
                title_en: 'Charcoal for the Forge',
                text_cs: 'Uhlíři z okolí zklamali dodávku — kovářský cech prosí klášter o výpomoc uhlím, než se řetězec dodávek napraví.',
                text_en: "The local charcoal burners have failed to deliver — the smiths' guild asks the monastery to help with charcoal until the supply chain recovers.",
                requiredItems: [{ id: 'charcoal', qty: 5 }],
                rewardGrose: 8,
                guildRelationReward: 6,
            },
        ],
    ...
    // kacířská/hříšná zakázka. Historicky přesně na rok 1465: srpen 1465
    // papež Pavel II. obnovil půhon proti Jiřímu z Poděbrad, 28.11.1465
    // katolická šlechta ustavila Zelenohorskou jednotu. 2 jmenovité
    // (frakčně vyhrocené), 2 obecné/tajemné (neexponované jméno, mirror
    // "jméno neexponovat" principu z visitatio-reference.md). Zvyšuje
    // inquisitionHeat (existující L16/inq_raid vlákno) a snižuje abbotFavor
    // (trace pro budoucí Abbot screen — opat se dozví, čím dům riskuje).
    _KACIRSKA_ZAKAZKY_CATALOG: {
        kacirska: [
            {
                key: 'utrakvisticky_opis',
                icon: '⚜️',
                senderName_cs: 'Písař ze dvora krále Jiřího', senderName_en: "A Scribe from King Jiří's Court",
                title_cs: 'Opis pro věrné krále',
                title_en: 'A Copy for the Faithful of the King',
                text_cs: 'Přichází psaní bez pečeti, jen ústní vzkaz doručený pocestným: opsat kompaktátový spis pro sympatizanta krále Jiřího. Platí se dobře — mlčení se cení výš než práce.',
                text_en: "A letter arrives without a seal, only a spoken message brought by a traveller: copy a compactata-related text for a sympathizer of King Jiří. It pays well — silence is valued higher than the labour.",
                requiredItems: [{ id: 'paper', qty: 2 }, { id: 'ink', qty: 1 }],
                rewardGrose: 20,
                inquisitionHeatDelta: 10,
                abbotFavorDelta: -5,
            },
            {
                key: 'zelenohorska_provolani',
                icon: '🛡️',
                senderName_cs: 'Posel Zelenohorské jednoty', senderName_en: 'A Messenger of the Green Mountain League',
                title_cs: 'Provolání katolické šlechty',
                title_en: 'A Proclamation of the Catholic Nobility',
                text_cs: 'Jezdec v erbovním plášti žádá opis provolání jednoty, co se proti králi spikla u Zelené Hory. I tohle je psaní, které se nečte nahlas.',
                text_en: 'A rider in a heraldic cloak requests a copy of the league\'s proclamation, sworn against the king at Zelená Hora. This too is a writing not read aloud.',
                requiredItems: [{ id: 'paper', qty: 2 }, { id: 'ink', qty: 1 }],
                rewardGrose: 20,
                inquisitionHeatDelta: 10,
                abbotFavorDelta: -5,
            ...
            {
                key: 'podezrely_traktat',
                icon: '🔮',
                senderName_cs: 'Tajemný žadatel', senderName_en: 'A Mysterious Petitioner',
                title_cs: 'Spis s pochybnou pověstí',
                title_en: 'A Text of Dubious Repute',
                text_cs: 'Nikdo neví, odkud přišel vzkaz. Žádá opis astrologického traktátu, o němž se šeptá, že jeho autor skončil špatně. Odměna odpovídá riziku.',
                text_en: 'No one knows where the message came from. It asks for a copy of an astrological treatise, whispered to have brought its author to a bad end. The reward matches the risk.',
                requiredItems: [{ id: 'vellum', qty: 1 }, { id: 'ink_gallic', qty: 1 }],
                rewardGrose: 35,
                inquisitionHeatDelta: 15,
                abbotFavorDelta: -8,
            },
            {
                key: 'zahaleny_muz',
                icon: '🎭',
                senderName_cs: 'Zahalený muž', senderName_en: 'A Cloaked Man',
                title_cs: 'Spis o zkaženosti církve',
                title_en: 'A Text on the Corruption of the Church',
                text_cs: 'Přišel za soumraku, tvář skrytou kápí. Chce opis satirického spisku, co si utahuje z tlustých opatů a lakomých kanovníků. „Vždyť je to jen žert,“ říká — a odchází dřív, než mu lze věřit.',
                text_en: 'He came at dusk, face hidden by a hood. He wants a copy of a satirical pamphlet mocking fat abbots and greedy canons. "It is only a jest," he says — and leaves before he can be trusted.',
                requiredItems: [{ id: 'paper', qty: 1 }, { id: 'ink', qty: 1 }],
                rewardGrose: 15,
                inquisitionHeatDelta: 8,
                abbotFavorDelta: -6,
            },
        ],
    },

    // zakazky-rozsireni-ctyri-kategorie-mrd.md, Kategorie D (9.8.2026) —
    // církevní postava mimo biskupa. Poctivé, čestné zakázky — zvyšují
    // abbotFavor (trace pro budoucí Abbot screen), žádný inquisitionHeat
    // dopad. Papežský legát vědomě vynechán (MRD §5 — příliš blízko
    // Visitatio endgame vláknu).
    _CIRKEVNI_ZAKAZKY_CATALOG: {
        cirkevni_mimo_biskupa: [
            {
                key: 'meziknihovni_vypujcka',
                icon: '📖',
                senderName_cs: 'Opat kláštera Hradisko', senderName_en: 'The Abbot of Hradisko Monastery',
                title_cs: 'Zapůjčení exempláře k opsání',
                title_en: 'Loan of an Exemplar for Copying',
                text_cs: 'Bratrský klášter posílá vzácný exemplář se žádostí o opis — meziklášterní laskavost, jak bývá zvykem mezi domy stejné řehole. Opat žádá pečlivost, ne spěch.',
                text_en: 'A brother house sends a rare exemplar with a request for a copy — an inter-monastery courtesy, as is customary among houses of the same rule. The abbot asks for care, not haste.',
            ...
            {
                key: 'kancional_pro_farnost',
                icon: '🎵',
                senderName_cs: 'Farní kněz z Bystřice', senderName_en: 'The Parish Priest of Bystřice',
                title_cs: 'Kancionál pro chudou farnost',
                title_en: 'A Hymnal for a Poor Parish',
                text_cs: 'Vesnický farář píše skromně a poctivě: jeho farnost nemá na pořádný kancionál, zpívají ze slov, co si kdo pamatuje. Prosí o opis — a modlí se za vás na oplátku.',
                text_en: 'The village priest writes modestly and honestly: his parish cannot afford a proper hymnal, they sing from whatever words are remembered. He asks for a copy — and prays for you in return.',
                requiredItems: [{ id: 'paper', qty: 2 }, { id: 'ink', qty: 1 }],
                rewardGrose: 10,
                reputationKey: 'lidovost', reputationAmt: 2,
                abbotFavorDelta: 6,
    ...
    // zakazky-rozsireni-ctyri-kategorie-mrd.md, Kategorie C (9.8.2026) —
    // mirror vrchnostZakazkyTick přesně, jen: (1) žádný reputation gate
    // (kacírská nabídka nepotřebuje, aby si tě šlechta/lid všimli), (2)
    // základní ~20% týdenní šance VÁŽENÁ živým Chronicon napětím kraje
    // (region.tension přes ChroniconSystem.getBuffs() — vyšší napětí =
    // o něco pravděpodobnější heretická nabídka, mirror tension_min/max
    // principu z narrative_README.md, ale čtení, ne psaní do Chroniconu).
    kacirskaZakazkyTick: function () {
        if (!Array.isArray(GameState.localAkterZakazky)) GameState.localAkterZakazky = [];
        const WEEK = 7 * 24 * 60 * 60 * 1000;
        if (!GameState.kacirskaZakazkyNextTick) {
            GameState.kacirskaZakazkyNextTick = Date.now() + Math.round(WEEK * 0.5);
            return;
        }
        if (Date.now() < GameState.kacirskaZakazkyNextTick) return;
        GameState.kacirskaZakazkyNextTick = Date.now() + WEEK;
        ...
        if (typeof ChroniconSystem !== 'undefined' && ChroniconSystem.getBuffs) {
            ...
            // 25 (výchozí) → beze změny; nad/pod 25 posune šanci max o ±0.10
            chance = Math.max(0.05, Math.min(0.35, 0.20 + (tension - 25) / 75 * 0.10));
        }
        if (Math.random() >= chance) return;

        if (GameState.localAkterZakazky.some(z => z.actorId === 'kacirska')) return;

        const options = this._KACIRSKA_ZAKAZKY_CATALOG.kacirska;
        const opt = options[Math.floor(Math.random() * options.length)];
        GameState.localAkterZakazky.push({
            id: 'akter_kacirska_' + opt.key + '_' + Date.now(),
            actorId: 'kacirska',
            key: opt.key,
            createdAt: Date.now(),
            deadlineDays: 7,
        ...
        if (typeof UI !== 'undefined' && UI.notifyPanel) UI.notifyPanel(
            (_lang === 'en' ? `📜 ${_senderName} has a request for you.` : `📜 ${_senderName} má pro tebe žádost.`), 'obchod');
        if (typeof Game !== 'undefined' && Game.addKronikaEntry) Game.addKronikaEntry('minor',
            `📜 Podezřelá zakázka od ${opt.senderName_cs}.`,
            `📜 A suspicious commission from ${opt.senderName_en}.`,
            `📜 Opus dubium oblatum est.`);
        if (typeof Game !== 'undefined' && Game.save) Game.save();
        this.render();
    },

    // zakazky-rozsireni-ctyri-kategorie-mrd.md, Kategorie D (9.8.2026) —
    // mirror vrchnostZakazkyTick přesně, žádný reputation gate, žádná
    // tension vazba (poctivé zakázky, ne kacířské — Chronicon napětí
    // sem nepatří).
    cirkevniZakazkyTick: function () {
        if (!Array.isArray(GameState.localAkterZakazky)) GameState.localAkterZakazky = [];
        const WEEK = 7 * 24 * 60 * 60 * 1000;
        if (!GameState.cirkevniZakazkyNextTick) {
            GameState.cirkevniZakazkyNextTick = Date.now() + Math.round(WEEK * 0.5);
            return;
        }
        if (Date.now() < GameState.cirkevniZakazkyNextTick) return;
        GameState.cirkevniZakazkyNextTick = Date.now() + WEEK;
        if (Math.random() >= 0.20) return;

        if (GameState.localAkterZakazky.some(z => z.actorId === 'cirkevni_mimo_biskupa')) return;

        const options = this._CIRKEVNI_ZAKAZKY_CATALOG.cirkevni_mimo_biskupa;
        const opt = options[Math.floor(Math.random() * options.length)];
        GameState.localAkterZakazky.push({
            id: 'akter_cirkevni_' + opt.key + '_' + Date.now(),
            actorId: 'cirkevni_mimo_biskupa',
            key: opt.key,
            createdAt: Date.now(),
            deadlineDays: 10,
        });
    ...
    // Cechy (cechy-a-prava-mrd.md §3.0, K3 Cesta A, 16.8.2026) — mirror
    // akterZakazkyTick přesně (víc odesílatelů, max 1 aktivní na cech),
    // gate na GuildsDB místo ContactsDB. Žádnej tech/book gate — cechy
    // jsou městská instituce, ne odemykatelnej kontakt.
    cechZakazkyTick: function () {
        if (!Array.isArray(GameState.localAkterZakazky)) GameState.localAkterZakazky = [];
        const DAY = 24 * 60 * 60 * 1000;
        if (!GameState.cechZakazkyNextTick) {
            GameState.cechZakazkyNextTick = Date.now() + Math.round(DAY * 0.3);
            return;
        }
        if (Date.now() < GameState.cechZakazkyNextTick) return;
        ...
        GUILDS_ACTIVE.forEach(guildId => {
            ...
            const options = this._CECH_ZAKAZKY_CATALOG[guildId];
            if (!options || !options.length) return;
            const opt = options[Math.floor(Math.random() * options.length)];
            GameState.localAkterZakazky.push({
                id: 'akter_' + guildId + '_' + opt.key + '_' + Date.now(),
                actorId: guildId,
                key: opt.key,
                createdAt: Date.now(),
                deadlineDays: 10,
    ...
    _normalizeLocalAkterEvent: function (z) {
        const lang = (GameState.settings && GameState.settings.language) || 'cs';
        // Hledá napříč všemi 6 katalogy (sklar/kovar/mlynar, Klientela A,
        // Vrchnost B, Kacírská C, Církevní D, Cechy — zakazky-rozsireni-
        // ctyri-kategorie-mrd.md, 9.8.2026 + cechy-a-prava-mrd.md, 16.8.2026)
        const options = this._AKTER_ZAKAZKY_CATALOG[z.actorId]
            ...
            || this._KACIRSKA_ZAKAZKY_CATALOG[z.actorId]
            || this._CIRKEVNI_ZAKAZKY_CATALOG[z.actorId]
            || this._CECH_ZAKAZKY_CATALOG[z.actorId];
        const opt = options && options.find(o => o.key === z.key);
        if (!opt) return null;
        const contact = (typeof ContactsDB !== 'undefined') ? ContactsDB[z.actorId] : null;
        // senderName_cs/en override — pro odesílatele bez ContactsDB záznamu (Vrchnost, Kacírská, Církevní, Cechy)
        ...
        return {
            ...
            // Cechy (cechy-a-prava-mrd.md §3.0, 16.8.2026) — samostatné pole,
            // resolver ho odlišuje od contactRelationReward (jiný cíl zápisu).
            guildRelationReward: opt.guildRelationReward,
            reputationKey: opt.reputationKey,
            reputationAmt: opt.reputationAmt,
            bonusItem: opt.bonusItem,
            // zakazky-rozsireni-ctyri-kategorie-mrd.md §"traces" (9.8.2026) —
            // háček pro budoucí Abbot screen, nikým dnes nečtený krom
            // resolveLocalAkter samotného. inquisitionHeatDelta jen Kategorie C.
            inquisitionHeatDelta: opt.inquisitionHeatDelta,
            abbotFavorDelta: opt.abbotFavorDelta,
            daysLeft: daysLeft,
        };
    },
    ...
    resolveLocalAkter: function (id, choiceId) {
        ...
        if (choiceId === 'accept') {
            ...
            // zakazky-rozsireni-ctyri-kategorie-mrd.md §"traces" (9.8.2026) —
            // Kategorie C zvyšuje existující inquisitionHeat (L16/inq_raid
            // vlákno). Obě C i D mění abbotFavor — dnes jen tichý háček,
            // nikým nečtený krom budoucího Abbot screen; lazy-init mirror
            // vzoru z core/game.js (laboratoryUnlocked apod.).
            if (item.inquisitionHeatDelta) {
                if (!GameState.secrets) GameState.secrets = {};
                GameState.secrets.inquisitionHeat = Math.max(0, (GameState.secrets.inquisitionHeat || 0) + item.inquisitionHeatDelta);
            }
