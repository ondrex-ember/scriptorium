...
const CommitmentsSystem = {
    ...
    _normalizeLocalAkterEvent: function (z) {
        const lang = (GameState.settings && GameState.settings.language) || 'cs';
        // Hledá napříč všemi 5 katalogy (sklar/kovar/mlynar, Klientela A,
        // Vrchnost B, Kacírská C, Církevní D — zakazky-rozsireni-ctyri-
        // kategorie-mrd.md, 9.8.2026)
        ...
        // senderName_cs/en override — pro odesílatele bez ContactsDB záznamu (Vrchnost, Kacírská, Církevní)
