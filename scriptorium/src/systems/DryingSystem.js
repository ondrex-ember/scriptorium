...
const DryingSystem = {
    ...
    renderFoculus: function() {
        ...
        if (active) {
            ...
            const hoursLeft = Math.max(0, Math.ceil((totalMs - elapsed) / 3600000));
            ...
            h += `<div style="font-size:0.72rem; opacity:0.65; margin-top:4px; text-align:center;">${pct}% — ${lang === 'en' ? hoursLeft + 'h left' : 'zbývá ' + hoursLeft + 'h'}</div>`;
        } else {
