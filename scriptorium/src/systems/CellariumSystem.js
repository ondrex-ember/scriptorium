    ...
    if (!hasCarp) {
      ...
      const dormTiers = [
        ...
        { id: 'dormitorium_ii',  icon: '📿', label: lang==='en'?'Dormitorium II':'Dormitorium II',
          ...
          cost: { cut_stone: 90, plank: 60, rope: 25, iron_ingot: 2 }, grose: 35, reqPrev: 'dormitorium_i' },
        { id: 'dormitorium_iii', icon: '📿', label: lang==='en'?'Dormitorium III':'Dormitorium III',
          ...
          cost: { cut_stone: 200, plank: 130, rope: 50, iron_ingot: 6, glass_stopper: 4 }, grose: 70, reqPrev: 'dormitorium_ii' },
      ];
      let dormInner = '';
      dormTiers.forEach(d => {
