...
const AthanorDB = {
  ...
  ingredients: [
    ...
    // metallurgia-rara-mrd (21.9.2026) — chybělo v AthanorDB.ingredients, ač je
    // v ItemsDB i v combo 'antimony+lead+tin:calcinatio' (tiskarska_slitina).
    // Bez tohoto záznamu se antimon v laboratoři nikdy nezobrazil, i když ho
    // hráč měl v inventáři. Gate zůstává na mine_antimony_ore (tech_metallurgia_rara),
    // stejně jako u lead/copper/tin.
    {
      id: 'antimony', name: 'Antimon', name_en: 'Antimony', name_lat: 'Stibium', rarity: 'uncommon', source: 'existing',
      color: '#3a3a3a', icon: '⬛', thermal: -2, moisture: -2,
      lore: "Těžký, lesklý šedočerný minerál z hlubších štol. Alchymisté mu říkají 'vlk kovů' — čistí zlato od nečistot.",
      lore_en: "A heavy, lustrous grey-black mineral from deeper shafts. Alchemists call it the 'wolf of metals' — it purifies gold of impurities.",
      dropNote: 'Vzácná ruda z hlubších štol Dolů.',
      dropNote_en: 'A rare ore from the deeper mine shafts.'
    },
    {
