...
const NotificationSystem = {
    ...
    toastAccum: function(gains) {
        ...
        if (!this._accumEl || !this._accumEl.isConnected) {
            ...
            this._accumEl.className = 'toast ns-toast-accum';
...
.ns-toast--error { border-color: #c0392b; color: #c0392b; }
.ns-toast--warn  { border-color: #e67e22; }
