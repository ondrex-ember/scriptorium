...
const UI = {
    ...
    switchHomeSubTab: function (tab, btn) {
        ...
        // Pivovar — pivovar-varecne-pravo-mrd.md v0.3, 7.9.2026, mirror bedna_dilna dispatch.
        if (tab === 'pivovar' && pivovar && typeof CellariumSystem !== 'undefined') {
            pivovar.innerHTML = CellariumSystem.renderPivovarTab();
        }
    },
