const Game = {
    ...
    _seasonMult: function (itemId) {
        ...
        const idx = this._getApiarySeason();
    ...
    stockCaughtFish: function(invSpecies, qty) {
        ...
        this.removeItem(invSpecies, qty);

        if (!GameState.piscinaSadky) GameState.piscinaSadky = [];
        GameState.piscinaSadky.push({ id: Game._piscinaNextId(), species: sadkySpecies, qty: qty, enteredAt: Date.now(), phase: 'fresh' });
        this.addItem(sadkySpecies + '_sadky_fresh', qty);
        Game.save(); UI.renderPiscina();
    ...
    _scavengeReward: function(type, r) {
        ...
        if (type === 'hunt') {
            ...
            if (sr < 0.35) this.addItem('pstruh', qty);
            else if (sr < 0.65) this.addItem('carp', qty);
            else if (sr < 0.85) this.addItem('uhor', qty);
            else this.addItem('stika', qty);
