...
const STRINGS_cs = {
    ...
    minigames: {
        ...
        ur: {
            need_board: "❌ Potřebuješ Královskou Desku z Uru!",
            err_move_first: "❌ Nejprve proveď tah!",
            err_invalid: "❌ Neplatný tah!",
            err_no_moves: "❌ Žádné platné tahy!",
            roll_zero_skip: "💀 Hod 0 - přeskakuješ!",
            roll_zero_retry: "💀 Hod 0 - zkus znovu!",
            roll_success: "🎲 Hodil jsi {roll}! Vyber žeton.",
            rosette: "✨ Roseta! Hraj znovu!",
            capture: "⚔️ Vyhodil jsi soupeře!",
            ai_roll_zero: "🤖 AI hodil 0",
            ai_no_moves: "🤖 AI nemůže táhnout",
            ai_move: "🤖 AI táhl na pole {pos}",
            ai_rosette: "✨ AI trefil rosetu!",
            win_vs: "🏆 VÝHRA! +{reward} Vědění",
            loss_vs: "💀 Prohra! AI vyhrál.",
            win_solo: "🏆 {grade}! +{reward} Vědění ({rolls} hodů)",
            title_vs: "🎲 Královská Hra z Uru (2600 př.n.l.)",
            subtitle_vs: "Nejstarší desková hra světa!",
            desc_vs: "Závoď s AI, kdo první dostane 7 žetonů do cíle.",
            title_solo: "🧩 Královská Hra z Uru - Solo Puzzle",
            subtitle_solo: "Dostaň všech 7 žetonů do cíle!",
            btn_vs_ai: "Hrát vs AI 🎮",
            btn_solo: "Solo Puzzle 🧩",
            btn_play_solo: "Hrát Solo 🧩",
            btn_back_vs: "Zpět na VS AI 🤖",
            btn_roll: "🎲 Hodit kostky",
            label_you: "Ty",
            label_ai: "AI",
            label_moves: "Tahy",
            label_roll: "Hod: {roll}",
            label_finished: "Dokončeno",
            label_rolls: "Hody",
            label_offboard: "Žetony mimo desku ({count}):",
            label_track: "Herní dráha:",
            label_rating: "Hodnocení:",
            label_pace: "Aktuální tempo: {grade}",
            grade_perfect: "PERFEKTNÍ",
            grade_good: "VÝBORNÝ",
            grade_ok: "DOBRÝ",
            grade_pass: "OK",
            rating_perfect: "🏆 Perfektní: ≤{target} hodů (6 Vědění)",
            rating_good: "⭐ Výborný: ≤{target} hodů (4 Vědění)",
            rating_ok: "✓ Dobrý: ≤{target} hodů (3 Vědění)",
            rating_pass: "○ OK: {target}+ hodů (2 Vědění)"
        }
    },
    library_lore: {
