...
garden: {
  ...
  rithmoRulesMovement: '🎯 Pohyb: Kruhy se pohybují o 1 pole, Čtverce o 2, Trojúhelníky o 3. Pyramidy kombinují všechny.',
  rithmoRulesCapture: '⚔️ Zajímání: Můžeš zajmout soupeřův kámen pokud tvoje číslo odpovídá matematickému vztahu (rovnost, násobek, rozdíl).',
  rithmoRulesVictory: '🏆 Vítězství: Zajmi 3 pyramidy soupeře NEBO překroč 160 bodů ze zajatých kamenů.',
  rithmoRulesHistory: '📜 Historie: Hra pochází z roku 1030, hrála se na středověkých univerzitách jako cvičení z aritmetiky a geometrie.',
