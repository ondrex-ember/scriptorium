...
const STRINGS_cs = {
    ...
    settingsUI: {
        ...
        designIluminovana: '📜 Iluminovaná (rukopisný vzhled)',
        designStyleDesc: 'Volba mezi světským Art Deco, skromným řeholním a iluminovaným rukopisným vzhledem.',
        reset: 'Reset',
    ...
    about: {
        ...
        r797_1: 'Stationarius & dynamické rozhovory — nové NPC a systém proměnlivých dialogů podle kontextu',
        r797_2: 'Cechy — vztahy s cechy, napětí mezi bratrstvími a raid eventy',
        r797_3: 'Nové dílny — Těžba (lom), Kuchyně, Sušárna, Vápenice, Mlýn, Pekárna (Furnus), Kovárna a první krok Truhlárny',
        r797_4: 'Pozemky — nové parcely pro rozšíření zástavby kláštera',
        r797_5: 'Porta & Zakázky — rozšířený zakázkový systém',
        r797_6: 'Chlévy & Dvůr — optimalizace a vyladění hospodářství',
        r797_7: 'Knihovna — katalogizace (hra M.A.R.C.), výpůjčky, ochrana proti padělkům',
        r797_8: 'Monastery Sokoban — zbrusu nová minihra',
        r797_9: 'Foculus — přepracovaná záložka ohniště, optimalizace paliva',
        r797_10: 'Dormitorium & Conversi — vylepšený systém laických bratří',
        r797_11: 'Opisování rukopisů & Denní řád — vyladění a rozšíření',
        r797_12: 'Kronika, Zprávy z kláštera & Persona — rozšíření a vylepšení',
        r797_13: 'Zahrada — kompletní revize a opravy všech částí',
        r797_14: 'Scavenge — nové akce sběru, vyladění sezónních výnosů',
        r797_15: 'Templum & Infirmarium — nové mechaniky a záložky',
        r797_16: 'Chronicon — hlubší obousměrné napojení na svět kláštera',
        r797_17: 'Vztahy s krajem — nový ukazatel a mechanika',
        r797_18: 'Opat — rozšířené mechaniky opatství',
        r797_19: 'Clientela — kompletně nový systém kontaktů s dodavateli',
        r797_20: 'Inventarium & Liber Rationum — opravy a optimalizace UI a logů',
        r797_21: 'Hřbitov — nové mechaniky a vizuální mapa hřbitova',
        r797_22: 'Ars Conservandi — zavařování, nové recepty a potraviny',
        r797_23: 'Knihvazba — vázaný kodex (fitted codex), nové techniky vazby',
        r797_24: 'Ukládání — refaktor SaveManager, spolehlivější zápis do IndexedDB',
    ...
    library_lore: {
        ...
        catalog_acquired: "Datum akvizice",
        ...
        npc_scribe: {
            ...
            scribe_short: '"Za {cost}x Papír ti odkryji jednu knihu předčasně..."',
            ...
            opt_trade: "Vyměnit ({cost}x Papír)",
    ...
    tidings: {
        ...
        flag_confectio: "Bratře, slyšel jsem o tvé nové marmeládě! Platina by měl radost — jeho De Honesta Voluptate popisuje přesně tohle, kdoulovou pastu k slávě stolu. Portugalci jí říkají marmelada, podle marmelo, jejich slova pro kdouli. My jsme takové věci vařili už dávno, jen bez cukru — med a trpělivost stačí. Pošli mi hrnec do sklepa, ať ochutnám dřív než myši.",
    ...
    cellarium: {
        ...
        giacomoBtnVisitClientela: 'Navštívit v Clientele',
        giacomoMarketHint: 'Teď ho tu nezastihneš — trh je zavřený nebo je jeho loď na moři. Jakmile dosáhneš hodnosti antiquarius, najdeš ho kdykoliv v Clientele.',
    ...
    farmyard: {
        ...
        oxSlaughtered: 'Vůl poražen.',
        noOxToSlaughter: 'Žádný vůl k porážce.',
    ...
    abbotPetition: {
        ...
        // kovarna-dilna-mrd.md v0.5 (30.8.2026) — mirror furnus/land_dvur_pekarsky přesně.
        kovarna: {
            title: 'Žádost o stavbu kovárny',
            submit_btn: 'Zaslat žádost opatovi',
            pending: '⏳ Žádost odeslána {date}. Opat odpoví {responseDate}.',
            approved: '✅ Opat schválil stavbu Kovárny. Dílna může být postavena.',
            denied_tech: '❌ Opat zamítl: Klášter dosud nezná řemeslo podkováře. Prostuduj: Kovárna — Řemeslo Podkováře.',
            denied_parcel: '❌ Opat zamítl: Nejprve musí být získán Dvůr u hradební zdi (Cellarium — Pozemky).',
            denied_groats: '❌ Opat zamítl: Klášter nemá dostatek prostředků (70 grošů).',
            denied_anvil: '❌ Opat zamítl: Bez kovadliny nelze kovárnu vybavit.',
            kronika_submit: 'Odeslána žádost opatovi o stavbu kovárny. Odpověď očekávána {responseDate}.',
            kronika_approved: 'Opat schválil stavbu Kovárny. Kování podkov může začít.',
            kronika_denied: 'Opat zamítl žádost o Kovárnu. Důvod: {reason}',
            inspect_hint: 'Opat přislíbil inspekční návštěvu po dokončení stavby.',
        ...
        land_u_hradby: {
            ...
            submit_btn: 'Zaslat žádost opatovi',
            pending: '⏳ Žádost odeslána {date}. Opat odpoví {responseDate}.',
            approved: '✅ Opat schválil jednání o dvoře u hradební zdi. Parcelu jde koupit v Cellariu — Pozemky.',
            denied_regalia: '❌ Opat zamítl: Nejprve musíš prostudovat Regálie a otevřít jednání se Zemským pánem.',
            kronika_submit: 'Odeslána žádost opatovi o dvůr u hradební zdi. Odpověď očekávána {responseDate}.',
            kronika_approved: 'Opat schválil jednání o dvoře u hradební zdi.',
