...
const STRINGS_en = {
    ...
    settingsUI: {
        ...
        designMarniva: '✨ Vanity (new secular Art Deco style)',
        designPokorna: '🪨 Humble (older simpler style)',
        designIluminovana: '📜 Illuminated (manuscript style)',
        designStyleDesc: 'Choose between secular Art Deco, humble monastic, and illuminated manuscript styling.',
        reset: 'Reset',
    ...
    about: {
        ...
        r797_1: 'Stationarius & dynamic conversations — a new NPC and a system of context-based, non-linear dialogue',
        r797_2: 'Guilds — guild relations, inter-guild tension and raid events',
        r797_3: 'New workshops — Quarry, Kitchen, Drying Rack, Lime Kiln, Mill, Bakery (Furnus), Smithy and the first step of the Carpentry workshop',
        r797_4: 'Land parcels — new plots for expanding the monastery grounds',
        r797_5: 'Porta & Commissions — expanded commission and contract system',
        r797_6: 'Stables & Yard — optimised and rebalanced husbandry',
        r797_7: 'Library — cataloguing (the M.A.R.C. minigame), lending, forgery protection',
        r797_8: 'Monastery Sokoban — a brand new minigame',
        r797_9: 'Foculus — reworked hearth tab, fuel optimisation',
        r797_10: 'Dormitorium & Conversi — improved lay-brother system',
        r797_11: 'Manuscript Copying & Daily Office — tuning and expansion',
        r797_12: 'Chronicle, Monastery Tidings & Persona — expansion and improvements',
        r797_13: 'Garden — complete overhaul and fixes across every section',
        r797_14: 'Scavenging — new gathering actions, tuned seasonal yields',
        r797_15: 'Templum & Infirmarium — new mechanics and tabs',
        r797_16: 'Chronicon — deeper two-way connection to the wider world',
        r797_17: 'Regional relations — new indicator and mechanic',
        r797_18: 'Abbot — expanded abbey mechanics',
        r797_19: 'Clientela — a completely new vendor and supplier contact system',
        r797_20: 'Inventory & Ledger — UI and logging fixes and optimisation',
        r797_21: 'Cemetery — new mechanics and a visual cemetery map',
        r797_22: 'Ars Conservandi — preserving, new recipes and foodstuffs',
        r797_23: 'Bookbinding — the fitted codex, new binding techniques',
        r797_24: 'Save system — SaveManager refactor, more reliable IndexedDB writes',
    ...
    library_lore: {
        ...
        catalog_acquired: "Date of acquisition",
        ...
        npc_scribe: {
            ...
            scribe_short: '"For {cost}x Paper, I shall reveal one tome unto thee prematurely..."',
...
**GAME EFFECT:** Unlocks the Organum Hydraulicum tech — the construction of hydraulic organs. Without reading this treatise, the organ builder from Nuremberg shall not come.`
    ...
    tidings: {
        ...
        flag_confectio: "Brother, I hear of thy new marmalade! Platina himself would rejoice — his De Honesta Voluptate describes just this, a quince paste fit for the abbot's own table. The Portuguese call it marmelada, after marmelo, their word for quince. We have long made such things ourselves, only without sugar — honey and patience suffice. Send a pot down to the cellar, that I might taste it before the mice do.",
    ...
    cellarium: {
        ...
        giacomoBtnVisitClientela: 'Visit via Clientela',
        giacomoMarketHint: 'Not here right now — the market is closed or his ship is at sea. Once you reach the rank of Antiquarius, you\'ll find him anytime via Clientela.',
    ...
    farmyard: {
        ...
        oxSlaughtered: 'Ox slaughtered.',
        noOxToSlaughter: 'No ox to slaughter.',
...
*Recipes unlocked: Tin-Lead Alloy, Bronze, Sandarac Varnish, Copper Whitener.*`,
    ...
    abbotPetition: {
        ...
        // kovarna-dilna-mrd.md v0.5 (30.8.2026) — mirror furnus/land_dvur_pekarsky exactly.
        kovarna: {
            title: 'Request to Build a Smithy',
            submit_btn: 'Submit petition to the Abbot',
            pending: '⏳ Petition submitted {date}. The Abbot will reply by {responseDate}.',
            approved: '✅ The Abbot has approved the Kovárna. The smithy may be built.',
            denied_tech: '❌ Abbot denied: The monastery has not yet acquired the farrier\'s craft. Research: Kovárna — The Farrier\'s Craft.',
            denied_parcel: '❌ Abbot denied: The Wall-side Yard must be acquired first (Cellarium — Land).',
            denied_groats: '❌ Abbot denied: The monastery lacks sufficient funds (70 groats).',
            denied_anvil: '❌ Abbot denied: The smithy cannot be equipped without an anvil.',
            kronika_submit: 'Petition submitted to the Abbot for the Kovárna (smithy). Reply expected by {responseDate}.',
            kronika_approved: 'The Abbot approved the Kovárna. Horseshoe work may begin.',
            kronika_denied: 'The Abbot denied the petition for the Kovárna. Reason: {reason}',
            inspect_hint: 'The Abbot has promised an inspection visit once the smithy is complete.',
        ...
        land_u_hradby: {
            ...
            submit_btn: 'Submit petition to the Abbot',
            pending: '⏳ Petition submitted {date}. The Abbot will reply by {responseDate}.',
            approved: '✅ The Abbot approved dealings over the Wall-side Yard. The parcel may be bought in Cellarium — Land.',
            denied_regalia: '❌ Abbot denied: You must first study the Regalia and open dealings with the Lord of the Manor.',
            kronika_submit: 'Petition submitted to the Abbot for the Wall-side Yard. Reply expected by {responseDate}.',
            kronika_approved: 'The Abbot approved dealings over the Wall-side Yard.',
